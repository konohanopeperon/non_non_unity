...
urlpatterns = [
    ...
    path('boards/<uuid:board_id>/participants/', views.board_participants, name='board_participants'),
    ...
    path('chat/create/<uuid:board_id>/', views.create_keijibanchat_room, name='create_keijibanchat_room'),
